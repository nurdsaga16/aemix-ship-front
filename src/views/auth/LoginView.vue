        ...
        <div class="max-w-sm">
          <GlassCard class="mb-4" :delay="0.1">
            <div class="flex items-center gap-3">
              ...
              <div>
                <h1 class="text-caps text-xl">ВХОД</h1>
                <p class="text-muted-foreground text-xs md:text-sm leading-relaxed">
                  Войдите в свой аккаунт AEMIX Galaxy, чтобы продолжить отслеживание заказов.
                </p>
              </div>
            </div>
          </GlassCard>
          ...
          <GlassCard :delay="0.2">
            <div>
              ...
              <div class="pt-2">
                ...
                <div id="telegram-login-container" class="flex justify-center mb-3" />
                ...
                <div class="flex items-center justify-between text-xs text-muted-foreground">
                  ...
                  >
                    Нет аккаунта?
                    <span class="text-accent-italic">Зарегистрироваться</span>
                  </button>
                  <button
                    type="button"
